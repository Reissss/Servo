...
def movingcenter():
    ...
    while 1:
        ...
        v = (0.015 + (0.0008167 * konum)) #Vmax=0.6
        dist=19
        count=0
        if konum > 45:
            msg1.velocity.z = 0
...
def waypointmove():
    ...
    glob_pos_pub (41.090422, 28.617919 , 0) #1. direk lat long
    glob_pos_pub (41.090503, 28.617613 , 0) #2. direk lat long
    glob_pos_pub (41.090428, 28.617871 , 0) #blue lat long
    movingcenter ()  # maviyi ortala alçal yüksel
    alcal (4)
    print (" 4 metreye *******ALCALDI*******")
    movingcenter ()  # maviyi ortala alçal yüksel
    alcal (1.9)
    print (" 1.9 metreye *******ALCALDI*******")
    modes.setLoiterMode ()
    # Su almayı bekle.
    rospy.sleep (15)
    print("SU ALINDI")
    ...
    glob_pos_pub( 41.090518 ,28.617790,0) #FARKLI BİR YERE LAND İÇİN GİT
